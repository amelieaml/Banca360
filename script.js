...
function applySavedTheme() {
    ...
    // Si no hay tema guardado, puedes decidir cuál es el por defecto.
    // Asumiremos 'light' (claro) por defecto si localStorage está vacío.
    
    if (savedTheme === 'dark') {
        document.documentElement.classList.add('dark-mode');
    } else {
        // Asegurarnos de quitarlo si el valor guardado es 'light'
        document.documentElement.classList.remove('dark-mode');
    }
}

// Función para cambiar el icono (si tienes uno en el navbar)
...
// Lógica del botón de intercambio (Toggle)
const themeToggle = document.getElementById('theme-toggle');
if (themeToggle) {
    themeToggle.addEventListener('click', () => {
        const isDark = document.documentElement.classList.toggle('dark-mode');
        
        // Guardar la elección para la siguiente página
